      ...
      details: [
        {
          ...
          icon: <SafetyOutlined />,
          items: ['حراسة وقائية ثقافية', 'حراسة وقائية رياضية', 'حراسات مختلفة']
        },
        {
          title: 'حصص توعوية',
          icon: <BookOutlined />,
          items: ['حصص توعوية في المدارس', 'حصص توعوية في المعاهد', 'حملات تحسيسية مجتمعية شاملة']
        },
        {
          title: 'عمليات بيضاء',
          icon: <HeartOutlined />,
          items: ['عملية بيضاء في الإطفاء','عملية بيضاء في الإسعاف', 'عملية بيضاء في الإنقاذ']
        },
        {
